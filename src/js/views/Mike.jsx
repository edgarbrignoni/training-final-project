                ...
                <div className="container">
                    <div id="custinfo"className="row">
                        ...
                        <div className="col-xs-12 col-md-6">
                            <div className="row">
                                <div className="col-6">
                                    <h3 className="goaltitle">OVERALL GOAL</h3>
                                </div>
                                <div className="col-6 text-right">    
                            ...
                            <div className="row">    
                                <div className="col-sm-12 col-sm-6 text-center">
                                    <p className="empty">THIS IS YOUR OVERALL GOAL.</p>
                                </div>
                            </div>    
                        </div>
                    </div>
                    <div id="custWG" className="row">
                        <div className="col-sm-6">
                            <div className="card bg-light mb-3">
                                <div id="bctitle" className="card-header">
                                    <div className="row">
                                        <div className="col-md-8">
                                            <h6>Current Body Composition</h6>
                                        </div>
                                        <div className="col-md-4 text-right">
                                            <ul>
                                                <li className="add">
                                                    <a href="#"><div className="icon"></div>Add Goal</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>    
                                ...
                                <div className="row">
                                    <div id="cwdiv" className="col-6 text-center">
                                    ...
                                    <div id="cbfdiv" className="col-6 text-center">
                                ...
                                <div className="row">
                                    ...
                                    <div id="lbmdiv"className="col-6 text-right">
                                        <div className="stats">
                        ...
                        <div className="col-sm-6">
                            <div className="card bg-light mb-3">
                                <div id="wbftitle" className="card-header">
                                    <div className="row">
                                        <div className="col-md-6">
                                            <h6>Weight &amp; Body Fat Goals</h6>
                                        </div>    
                                ...
                                <div className="row">
                                    ...
                                    <div id="descdiv"className="col-6 text-right">
                    ...
                    <div className="card bg-light">
                        ...
                        <div id="photoprogress"className="row">
                        ...
                        <div className="col-12">
                            <div className="month">
                                <ul>
                                    ...
                                    <li>Your weekly workout<br></br><span>2017</span></li>
                                </ul>
                            </div>
                        </div>     
                    </div>
                    ...
                    <div id="programCard"className="card text-center">
                        <div className="card-header">
