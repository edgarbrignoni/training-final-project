                            ...
                            return (
                                <div className="container">
                                    <div className="container p-0">
                                        <div className="row">
                                            <div className="col-md-12 blog-main-disable">
                                                <div className="col-sm-12 col-md-6">
                                                    <div className="videoWrapper">
                                                        <iframe 
                                                            src={"" + post.meta_keys.video +  "?rel=0&showinfo=0&autoplay=1&controls=1&modestbranding=1"}
                                                            frameBorder="0"
                                                            allowFullScreen
                                                        >
                                                        </iframe>
                                                ...
                                                <br />
                                                <div className="col-sm-12 col-md-6 blog-post">
